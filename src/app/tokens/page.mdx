...
import { DownloadTokensButton } from '@/components/DownloadTokensButton'
...
/* ---------------------------------------------------------
   Black Scale
   Aligned with the Tailwind zinc palette for consistent
   neutral greys across light mode.
   --------------------------------------------------------- */
:root {
...
/* ---------------------------------------------------------
   Semantic Colours
   Traffic-light system for status, feedback and system state.
   --------------------------------------------------------- */
:root {
...
/* ---------------------------------------------------------
   Font Sizes
   Strict 8-pixel-divisible scale from 14 through 72 pixels.
   --------------------------------------------------------- */
:root {
  ...
  --font-size-h2:        2rem;
  --font-size-h1:        2.5rem;
  --font-size-feature:   3rem;
  --font-size-marketing: 3.5rem;
  --font-size-hero:      4rem;
...
/* ---------------------------------------------------------
   Spacing
   Based on an 8-pixel grid system for consistent rhythm.
   --------------------------------------------------------- */
:root {
  --space-1:  0.25rem;
  --space-2:  0.5rem;
...
<div className="not-prose my-8">
  <DownloadTokensButton content={TOKENS_CSS} filename="upa-design-tokens.css" />
</div>
