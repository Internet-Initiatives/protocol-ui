...
Built on the Tailwind CSS palette and meeting WCAG 2.1 AA contrast standards throughout, the Ultimate Performance Academy colour system covers the brand triad, full tonal scales, semantic status colours, call-to-action pairings and accessibility guidance. Click any swatch to copy its hex. {{ className: 'lead' }}
