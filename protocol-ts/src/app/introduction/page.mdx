...
<div className="not-prose mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
  ...
  <div className="group relative overflow-hidden rounded-xl border border-zinc-900/10 p-6 transition-all duration-200 hover:border-[#FFCB05] hover:shadow-lg dark:border-white/10 dark:hover:border-[#FFCB05]">
    ...
    <div className="mt-3 text-sm text-zinc-600 dark:text-zinc-400">
      Our three primary brand colors are Yellow (#FFCB05), Black (#171717), and White (#FFFFFF). These colors form the foundation of the UPA visual identity across all applications and materials.
    </div>
  </div>
